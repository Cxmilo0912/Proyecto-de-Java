...
<html class="dark" lang="es"><head>
    ...
    <body class="bg-background-light dark:bg-background-dark font-display">
        <%
            ...
            try { new CategoriaDAO().sembrarCategoriasIngresoPorDefecto(1); } catch (Exception e) {}
            try { categorias = new CategoriaDAO().listarPorTipo("Ingreso"); } catch (Exception e) { categorias = java.util.Collections.emptyList(); }
            ...
            if ("POST".equalsIgnoreCase(request.getMethod())) {
                ...
                try {
                    ...
                    else { msg = "Error al guardar el ingreso"; tipo = "danger"; }
                } catch (Exception ex) {
